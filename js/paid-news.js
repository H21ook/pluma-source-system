  ...
  if (steps) {
    ...
    if (indicator) {
      ...
      if (indicator.children.length === currentStep) {
        document.getElementById("sentOpenModal").classList.remove("hidden");
        document.getElementById("nextStep").classList.add("hidden");
      } else {
        document.getElementById("sentOpenModal").classList.add("hidden");
